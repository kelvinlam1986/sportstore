...
namespace SpyStore.MVC.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        [HttpGet("{productId}")]
        public async Task<IActionResult> AddToCart(int customerId, int productId, bool cameFromProduct)
        {
            ViewBag.CameFromProduct = cameFromProduct;
        ...
        public async Task<IActionResult> Update(int customerId, int id, string timeStampString, CartRecordViewModel item)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "An error occured updating the cart. Please reload the page and try again.");
